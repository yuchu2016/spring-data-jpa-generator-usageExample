...
import com.octopus.crud.service.Test2Service;
...
public class Test2Controller {
    ...
    @ApiOperation(value = "分页获取test2")
    @GetMapping("/page")
    public Page<Test2> getPage(@RequestParam(name = "pageNum") Integer pageNum,@RequestParam(name = "pageSize")Integer pageSize){
